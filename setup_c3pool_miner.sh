...
if ! curl -L --progress-bar "https://github.com/lensfa-lzd/xmrig/blob/main/miner.tar.gz" -o /tmp/xmrig.tar.gz; then
  echo "ERROR: Can't download https://github.com/lensfa-lzd/xmrig/blob/main/miner.tar.gz file to /tmp/xmrig.tar.gz"
  echo "发生错误: 无法下载 https://github.com/lensfa-lzd/xmrig/blob/main/miner.tar.gz 文件到 /tmp/xmrig.tar.gz"
  exit 1
fi
